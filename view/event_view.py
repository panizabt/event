...
class EventView:
    ...
    def __init__(self):
        ...
        self.start_date_time = LabelWithEntry(win, "Start_date_time", 20, 90)
        self.end_date_time = LabelWithEntry(win, "End_date_time", 20, 120)
        self.event_type = LabelWithEntry(win, "Event_type", 20, 150)
        self.duration = LabelWithEntry(win, "Duration", 20, 180, data_type="int")
        self.description = LabelWithEntry(win, "Description", 20, 210)
        self.price = LabelWithEntry(win, "Price", 20, 240, data_type="int")
        self.salon_id = LabelWithEntry(win, "Salon", 20, 270, data_type="int")
